...
export default class DLWallet extends Wallet {
  ...
  async cancelDataLayerOffer(args: { tradeId: string; secure: boolean; fee?: number }) {
  ...
  async deleteDataLayerKey(args: { id: string; key: string; fee?: number }) {
