...
describe('Message', () => {
  ...
  describe('constructor', () => {
    ...
    it('should set a random requestId if none is provided', () => {
      ...
      randomBytes.mockReturnValueOnce(Buffer.from('test'));
      const message = new Message(options);
  ...
  //   describe('toJSON', () => {
  //     it('should return a JSON string with camelCase keys if useSnakeCase is false', () => {
  //       const options = {
  //         command: 'test',
  //         origin: 'test',
  //         destination: 'test',
  ...
  //       const json = message.toJSON(false);
  //       expect(json).toEqual(
  //         '{"command":"test","data":{"test":"test"},"origin":"test","destination":"test","ack":true,"requestId":"test"}'
  //       );
  //     });
  ...
  //       const json = message.toJSON(true);
  //       expect(json).toEqual(
  //         '{"command":"test","data":{"test":"test"},"origin":"test","destination":"test","ack":true,"request_id":"test"}'
  //       );
  //     });
  //   });
  ...
  //       expect(message.origin).toEqual('test');
  //       expect(message.destination).toEqual('test');
  //       expect(message.data).toEqual({ test: 'test' });
  //       expect(message.ack).toEqual(true);
  //       expect(message.requestId).toEqual('test');
  //     });

  //     it('should return a new Message instance from a JSON string with snake_case keys if useCamelCase is false', () => {
  //       const json =
  //         '{"command":"test","data":{"test":"test"},"origin":"test","destination":"test","ack":true,"request_id":"test"}';
  //       const message = Message.fromJSON(json, false);
  //       expect(message.command).toEqual('test');
